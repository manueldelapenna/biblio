...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body>
      ...
      jQuery.datepicker.setDefaults(jQuery.datepicker.regional["<?php echo $sf_user->getCulture() ?>"]);  
    </script>
      ...
      <div id="menubar">
        <div id="menu">
            ...
            <ul class="menu">
                ...
                <li><?php echo link_to("<span>Socios</span>","socio/index")?></li>
                <li><?php echo link_to("<span>Deudores</span>","socioConDeuda/index")?></li>
